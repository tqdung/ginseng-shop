...
import classes from "./CategoryParent.scss";
...
class CategoryParent extends React.Component {
  catParams;
  filterParams = {
    event: null,
    holiday: null,
    ...
    axios
      .get(endPoints.PRODUCT_CATEGORY_API, {
        params: {
          ...
          category: this.props.history.location.pathname.split("/")[2]
        }
      })
      .then(res => {
        this.setState(
    ...
    axios
      .get(endPoints.PRODUCT_LIST_API, {
        params: {
          page: this.props.history.location.pathname.split("/")[1],
          of: this.props.history.location.pathname.split("/")[2],
          category: this.props.history.location.pathname.split("/")[3]
        }
      })
      .then(res => {
        this.setState(
