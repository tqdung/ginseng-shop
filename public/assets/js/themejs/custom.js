...
$(document).ready(function() {
  ...
  if ($(window).width() > 979) {
    ...
    $(".myaccount > .dropdown-toggle").click(function() {
      ...
      $(".responsive-menu .nav.navbar-nav").slideUp("slow");
...
function menuResponsive() {
  ...
  if ($(window).width() < 980) {
    ...
    $("#menu .nav > li.dropdown .mobile_togglemenu").click(function(e) {
      e.stopPropagation();
      $(this)
        .parent()
        .toggleClass("active");
    ...
    $("#menu .nav > li.dropdown").click(function(e) {
      e.stopPropagation();
      $(this).toggleClass("active");
      $(this)
...
$(document).ready(function() {
  ...
  $(".nav-responsive").click(function() {
    ...
    if ($(".nav-responsive div").hasClass("active")) {
      $(".cart-menu").slideUp("slow");
      $(".myaccount-menu").slideUp("slow");
    }
  });
...
$(document).ready(function() {
  $("body").append(
    "<a class='top_button' title='Lên đầu trang' href=''>TOP</a>"
  );
  $(function() {
